...
---
## **<span style="background-color:#fff5b1">자바와 익숙해지기 - 6장. 메서드와 변수의 스코프</span>**
...
---
## **<span style="background-color:#fff5b1"> 자바와 익숙해지기 - **7장. 클래스와 인스턴스**</span>**
...
- [Java™ Platform, Standard Edition 8 API Specification](https://docs.oracle.com/javase/8/docs/api/index.html)
  - [Class BufferedReader](https://docs.oracle.com/javase/8/docs/api/index.html)
