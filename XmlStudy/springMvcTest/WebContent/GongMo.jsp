...
<link rel="stylesheet" type="text/css" href="<%=cp %>/css/gongmo.css">
</head>
<body>
    <!-- 상단바 -->
    <%-- <div id="topMenu">
    ...
    // 파라미터로 인증 상태 확인
    String auth = "true";//request.getParameter("auth");
    if ("true".equals(auth)) {
    ...
    <!-- 비밀번호 확인 모달 -->
    <div class="modal-overlay <%=isAuthenticated ? "hidden" : ""%>"
        id="passwordModal">
        <div class="password-modal">
            <h2 class="modal-title">🔒 본인 확인</h2>
            <p class="modal-description">
                개인정보 보호를 위해<br> 비밀번호를 다시 한 번 입력해주세요.
            </p>
            ...
            <div class="modal-buttons">
                ...
                <button class="modal-btn modal-btn-confirm"
                    onclick="verifyPassword()">확인</button>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="tab-navigation">
            <button class="tab-btn active" onclick="showTab('basic')">기본
                정보</button>
        ...
        <div class="profile-container active" id="tab-basic">
            ...
            <div class="section">
                ...
                <div class="form-group">
                    ...
                    <div class="input-with-button">
                        <input type="text" class="form-input" id="nickname"
                            value="행복한토끼99" placeholder="닉네임 입력">
                ...
                <div class="form-group">
                    <label class="form-label">비밀번호 변경</label> <input type="password"
                        class="form-input" id="newPassword"
                ...
                <div class="form-group">
                    <label class="form-label">비밀번호 확인</label> <input type="password"
                        class="form-input" id="confirmNewPassword" placeholder="새 비밀번호 확인">
                ...
                <div class="form-group">
                    ...
                    <div class="input-with-button">
                        ...
                        <button class="btn-send" onclick="sendEmailCode()">인증코드
                            발송</button>
                    </div>
                ...
                <div class="form-group" id="emailCodeSection" style="display: none;">
                    ...
                    <div class="input-with-button">
                        <input type="text" class="form-input" id="emailCode"
            ...
            <div class="section">
                ...
                <div class="toggle-item">
                    ...
                    <label class="toggle-switch"> <input type="checkbox"
                        class="toggle-input" checked> <span class="toggle-slider"></span>
                    </label>
                </div>
            </div>
                ...
                <table class="inquiry-table">
                    ...
                    <tbody>
                        <c:forEach var="inquiry" items="${inquiries}">
                            <tr onclick="location.href='inquiry/detail.do?inquiryNo=${inquiry.inquiryNo}'">
            ...
            <div class="withdraw-section">
                ...
                <div class="withdraw-reason">
                    ...
                    <div class="reason-options">
                        <label class="reason-option"> <input type="radio"
                            name="withdrawReason" value="1"> <span>더 이상 서비스를
                                이용하지 않음</span>
                        </label> <label class="reason-option"> <input type="radio"
                            name="withdrawReason" value="2"> <span>원하는 모임을 찾을
                                수 없음</span>
                        </label> <label class="reason-option"> <input type="radio"
                            name="withdrawReason" value="3"> <span>서비스 이용이 불편함</span>
                        </label> <label class="reason-option"> <input type="radio"
                            name="withdrawReason" value="4"> <span>개인정보 보호를 위해</span>
                        </label> <label class="reason-option"> <input type="radio"
                            name="withdrawReason" value="5"> <span>기타</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-input" id="withdrawComment"
                        style="min-height: 100px; resize: none; width: 100%;"
                        placeholder="서비스 개선을 위해 의견을 남겨주세요"></textarea>
                </div>
