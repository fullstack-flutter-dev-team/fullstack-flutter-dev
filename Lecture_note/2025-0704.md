## [2025-07-04 (금)]
---
- [20250704_01_scott.sql](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/OracleStudy/20250704_01_scott.sql)
- [20250704_02_scott.sql](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/OracleStudy/20250704_02_scott.sql)
- [20250704_01_hr.sql](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/OracleStudy/20250704_01_hr.sql)
- ⭐ [[Oracle] scott.sql](https://continua-conatus.tistory.com/283)
---

- ▣  ROW_NUMBER() 
  - ROW_NUMBER() OVER(ORDER BY CREATED) 
- ▣ JOIN(조인)
  1. SQL 1992 CODE
       - CROESS JOIN
       ...
       - EQUI JOIN
         - 서로 정확히 일치하는 데이터들끼리 연결시키는 결합 방법
