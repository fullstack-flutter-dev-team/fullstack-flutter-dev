## [2025-06-13 (금)]
---
- ⭐ [Java 컬렉션 프레임워크(Collection Framework) : Stack 자료구조에서의 요소 저장(push())과, 요소를 꺼내오는 메소드 peek()과 pop()의 차이](https://continua-conatus.tistory.com/224)
...
- <code style="background-color :rgba(8, 152, 236, 0.6)">**예외 처리(Exception Handling)**</code> - 교재(p.263)
- ⭐⭐⭐ [**Test153.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test153.java)
...
- **[Class Exception](https://docs.oracle.com/javase/8/docs/api/java/lang/Exception.html)**
- <code style="background-color :rgba(8, 152, 236, 0.6)">**예외 처리(Exception Handling)**</code> - 교재(p.263)
- ⭐⭐⭐ [**Test154.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test154.java)
...
- **[Class Exception](https://docs.oracle.com/javase/8/docs/api/java/lang/Exception.html)**
- <code style="background-color :rgba(8, 152, 236, 0.6)">**예외 처리(Exception Handling)**</code> - 교재(p.263)
- ⭐⭐⭐ [**Test155.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test155.java)
...
- **[Class Exception](https://docs.oracle.com/javase/8/docs/api/java/lang/Exception.html)**
- <code style="background-color :rgba(8, 152, 236, 0.6)">**예외 처리(Exception Handling)**</code> - 교재(p.263)
- ⭐⭐⭐ [**Test156.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test156.java)
...
- **[Class Exception](https://docs.oracle.com/javase/8/docs/api/java/lang/Exception.html)**
- <code style="background-color :rgba(8, 152, 236, 0.6)">**예외 처리(Exception Handling)**</code> - 교재(p.263)
- ⭐⭐⭐ [**Test157.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test157.java)
...
- **[Class Throwable](https://docs.oracle.com/javase/8/docs/api/java/lang/Throwable.html)**
- **[Class Exception](https://docs.oracle.com/javase/8/docs/api/java/lang/Exception.html)**
- <code style="background-color :rgba(8, 152, 236, 0.6)">**예외 처리(Exception Handling) - 예외 다시 던지기**</code> - 교재(p.)
- ⭐⭐⭐ [**Test158.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test158.java)
...
- **[Class Throwable](https://docs.oracle.com/javase/8/docs/api/java/lang/Throwable.html)**
- **[Class Exception](https://docs.oracle.com/javase/8/docs/api/java/lang/Exception.html)**
- <code style="background-color :rgba(8, 152, 236, 0.6)">**예외 처리(Exception Handling) - 다른 예외 다시 던지기, try~catch 로 처리**</code> - 교재(p.)
- ⭐⭐⭐ [**Test159.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test159.java)



### ■■■ 컬렉션 프레임워크(Collection Framework) ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**컬렉션 프레임워크(Collection Framework) - 스택(Stack)**</code> - 교재(p.335)
    ...
    ㄴjava.util.AbstractCollection<E>
        ㄴjava.util.AbstractList<E>
              ㄴjava.util.Vector<E>
                  ㄴjava.util.Stack<E>
  ```
- ⭐⭐⭐ [**Test160.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test160.java)
  - [boolean empty()](https://docs.oracle.com/javase/8/docs/api/java/util/Stack.html#empty--)
  - [E peek()](https://docs.oracle.com/javase/8/docs/api/java/util/Stack.html#peek--)
  - [E pop()](https://docs.oracle.com/javase/8/docs/api/java/util/Stack.html#pop--)
  - [E push(E item)](https://docs.oracle.com/javase/8/docs/api/java/util/Stack.html#push-E-)
  - [int search(Object o)](https://docs.oracle.com/javase/8/docs/api/java/util/Stack.html#search-java.lang.Object-)
    ...
    ㄴjava.util.AbstractCollection<E>
        ㄴjava.util.AbstractList<E>
              ㄴjava.util.Vector<E>
                  ㄴjava.util.Stack<E>
  ```
- ⭐⭐⭐ [**Test161.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test161.java)
