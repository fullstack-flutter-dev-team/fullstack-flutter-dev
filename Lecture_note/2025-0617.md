...
- **[Class HashMap<K,V>](https://docs.oracle.com/javase/8/docs/api/java/util/HashMap.html)**
  ...
  java.lang.Object
    ㄴjava.util.AbstractMap<K,V>
        ㄴjava.util.HashMap<K,V>
  ```
- ⭐⭐⭐ [**Test177.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test177.java)

### ■■■ 자바의 기본 입출력(I/O) ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**자바의 기본 입출력(I/O)**</code> - 교재(p.355)
- **[Test180.java](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test180.java)**
- **[Class System](https://docs.oracle.com/javase/8/docs/api/java/lang/System.html)**
  - [err](https://docs.oracle.com/javase/8/docs/api/java/lang/System.html#err)
  - [in](https://docs.oracle.com/javase/8/docs/api/java/lang/System.html#in)
  ...
  - [out](https://docs.oracle.com/javase/8/docs/api/java/lang/System.html#out)
    - [close()](https://docs.oracle.com/javase/8/docs/api/java/io/PrintStream.html#close--)
    - [flush()](https://docs.oracle.com/javase/8/docs/api/java/io/PrintStream.html#flush--)
    - [write(int b)](https://docs.oracle.com/javase/8/docs/api/java/io/PrintStream.html#write-int-)
  ...
  ```
- ⭐⭐⭐ [**Test178.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test178.java)

### ■■■ 자바의 기본 입출력(I/O) ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**자바의 기본 입출력(I/O) - OutputStream 실습**</code> - 교재(p.355)
- **[Class System](https://docs.oracle.com/javase/8/docs/api/java/lang/System.html)**
  - [err](https://docs.oracle.com/javase/8/docs/api/java/lang/System.html#err)
  - [in](https://docs.oracle.com/javase/8/docs/api/java/lang/System.html#in)
  - [out](https://docs.oracle.com/javase/8/docs/api/java/lang/System.html#out)
    - [close()](https://docs.oracle.com/javase/8/docs/api/java/io/OutputStreamWriter.html#close--)
    - [flush()](https://docs.oracle.com/javase/8/docs/api/java/io/OutputStreamWriter.html#flush--)
    - [write(int c)](https://docs.oracle.com/javase/8/docs/api/java/io/OutputStreamWriter.html#write-int-)
  ...
  java.lang.Object
    ㄴjava.io.OutputStream
        ㄴjava.io.FilterOutputStream
            ㄴjava.io.PrintStream
  ```
- ⭐⭐⭐ [**Test179.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test179.java)
...
### ■■■ 자바의 기본 입출력(I/O) ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**자바의 기본 입출력(I/O) - 출력 Buffer 와 flush()**</code> - 교재(p.355)
  ...
  java.lang.Object
    ㄴjava.io.OutputStream
        ㄴjava.io.FilterOutputStream
            ㄴjava.io.PrintStream
  ```
- ⭐⭐⭐ [**Test181.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test181.java)


### ■■■ 자바의 기본 입출력(I/O) ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**자바의 기본 입출력(I/O) - Reader Write 실습**</code> - 교재(p.355)
...
- [Class Writer](https://docs.oracle.com/javase/8/docs/api/java/io/Writer.html)
  ...
  ```
- ⭐⭐⭐ [**Test182java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test182.java)
