## [2025-05-20(화)]
- [**Test034.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test034.java)
- [**Test035.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test035.java)
- [**Test036.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test036.java)
- [**Test037.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test037.java)
- [**Test038.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test038.java)
- [**Test039.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test039.java)
- [**Test040.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test040.java)
- [**Test041.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test041.java)
- [**Test042.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test042.java)
...
```
- break **(break 키워드)**  문: **멈춰라 ✨ (+ 그리고 빠져나가라)**
- continue **(continue 키워드)**  문: **✨ (뒷부분 무시하고 +) 계속해라**
- 키워드 case, default를 가리켜 레이블 이라한다.
  ...
  ```
      switch (op)
      {
        ...
        default: return; // 1. 값을 반환, 2. 메서드 종료 → main() 메서드 종료 → 프로그램 종료
      }
  ```
  - return 키워드
    1. 값의 반환
