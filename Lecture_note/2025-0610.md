...
---
### ■■■ 클래스 고급 ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**중첩 클래스 ▶ Annonymous클래스(익명 클래스, 무명 클래스,, 이름없는 클래스)**</code>
- ⭐ [**Test129.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test129.java)
-  

### ■■■ 자바의 주요(중요) 클래스 ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**자바에서 기본적으로 제공하는 주요 클래스들**</code>
- ⭐ [**Test130.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test130.java)
-  



### ■■■ 자바의 주요(중요) 클래스 ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**Object 클래스**</code>
- ⭐ [**Test131.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test131.java)


### ■■■ 자바의 주요(중요) 클래스 ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**Object 클래스**</code>
- ⭐ [**Test132.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test132.java)

### ■■■ 자바의 주요(중요) 클래스 ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**Object 클래스**</code>
- ⭐ [**Test133.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test133.java)
  - equals()
  - toString()
  - hashCode()
  - getClass()
...
### ■■■ 자바의 주요(중요) 클래스 ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**Wrapper 클래스**</code>
- ⭐ [**Test134.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test134.java)
  - 업-캐스팅
  - 오토 박싱(Auto-Boxing)
...
### ■■■ 자바의 주요(중요) 클래스 ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**Wrapper 클래스**</code>
- ⭐ [**Test135.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test135.java)
  - 오토 박싱(Auto-Boxing)
  - 오토 언박싱(Auto-Unboxing)
---
### ✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅
