...
### ■■■ 클래스와 인스턴스 ■■■
-  생성자(Constructor)
- [**Test080.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test080.java)
-  
### ■■■ 클래스와 인스턴스 ■■■
-  생성자(Constructor)와 초기화 블럭(Initialized Block) ★★★
- [**Test082.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test082.java)

### ■■■ 배열 ■■■
-  배열의 선언과 초기화
- [**Test083.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test083.java)
- 배열의 개요
...
### ■■■ 배열 ■■■
- 배열의 기본적 활용
- [**Test084.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test084.java) - 임의의 정수들이 들어있는 배열. 그 배열의 숫자 데이터들 중 짝수인 요소만 골라서 출력하고, 3의 배수인 요소만 골라서 출력하는 프로그램을 구현한다.
...
- 배열의 선언과 초기화
- 배열의 기본적 활용
- [**Test085.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test085.java) - 『char』 자료형의 배열
- [**Test086.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test086.java) - 이름 배열과 전화번호 배열
- [**Test087.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test087.java) - 사용자로부터 임의의 정수를 임의의 갯수만큼 입력받아 입력받은 수 중에서 가장 큰 수를 출력하는 프로그램을 구현한다. 단, 배열을 활용하여 구현할 수 있도록 한다.
- [**Test088.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test088.java) - 사용자로부터 임의의 학생 수를 입력받고 입력받은 학생 수 만큼의 점수(정수 형태)를 입력받아 전체 학생 점수의 합, 평균, 편차를 구하여 결과를 출력하는 프로그램을 구현한다. 단, 배열을 활용하여 처리할 수 있도록 한다.
  ```
...
### ■■■ 배열 ■■■
- 다차원 배열(**배열의 배열**)
- [**Test089.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test089.java) - 다차원 배열(**배열의 배열**)
