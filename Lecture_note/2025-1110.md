...
- [kakao 맵 가이드](https://apis.map.kakao.com/web/guide/)
- ⭐⭐[KakaoMapApp](https://lstory.tistory.com/281#MapTest08.html)
  - [KakaoMapApp-09](https://lstory.tistory.com/281#MapTest09.html)
- ⭐⭐[KakaoMapStudy-1](https://continua-conatus.tistory.com/538)
- ⭐⭐[KakaoMapStudy-2](https://continua-conatus.tistory.com/540)

---
- ⭐⭐ [XPath개요 및 실습](https://planet-c.tistory.com/130)
 - [XmlApp07](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/tree/main/XmlStudy/XmlApp07)

---
#### 기상청 API허브
- URL :  [기상청API허브](https://apihub.kma.go.kr/)
- API 신청(API Key 발급)
  - 활용 분야 : 교육
  - 활용 목적 : 
    - 기타 > XML 데이터 및 API 활용 학습
    - 기타 > XML 데이터 및 API활용 학습
<br>
<br>

- 3.1 기상개황조회
-  URL : https://apihub.kma.go.kr/api/typ02/openApi/VilageFcstMsgService/getWthrSituation?pageNo=1&numOfRows=10&dataType=XML&stnId=108&authKey=xxxx
   - URL
...
- 3.2 육상예보조회
- URL : https://apihub.kma.go.kr/api/typ02/openApi/VilageFcstMsgService/getLandFcst?pageNo=1&numOfRows=10&dataType=XML&regId=11A00101&authKey=xxx
...
- [기상청 날씨누리](https://www.weather.go.kr/w/index.do)
  - [기상청_RSS](https://www.weather.go.kr/w/pop/rss-guide.do)
    - 홈페이지에 일일이 방문하지 않아도 업데이트 될 때마다 빠르고 편리하게 확인할 수 있습니다.
    - RSS(Really Simple Syndication, Rich Site Summary)
    - [1개월전망](https://www.kma.go.kr/repositary/xml/fct/mon/img/fct_mon1rss_108_20251023.xml)
    - 
  - 
- []()
- []()
- ⭐ [로컬 XML 파일 읽기 블로그](https://planet-c.tistory.com/128)
- ⭐⭐ [XML 스터디 블로그](https://continua-conatus.tistory.com/search/xml)
  - ⭐⭐[XmlApp04 블로그](https://continua-conatus.tistory.com/531)
 - [XmlApp04](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/tree/main/XmlStudy/XmlApp04)
   - XML DOM활용 → 로컬(local) XML 읽어내기
   - 콘솔 기반 자바 프로그램
   - VEHICLE.xml, breakfast_menu.xml, memberList.xml

---
### ▣▣▣ XML(eXtensible Markup Language) ▣▣▣
- ⭐⭐⭐[[XML] 001. XML 개요](https://planet-c.tistory.com/127)
- ⭐⭐ [XML 스터디](https://continua-conatus.tistory.com/search/xml)
- [01_XML.md](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/XmlStudy/01_XML.md)
- [02_DTD.md](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/XmlStudy/02_DTD.md)
- [XmlApp01](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/tree/main/XmlStudy/XmlApp01)
- [XmlApp02](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/tree/main/XmlStudy/XmlApp02)
  - DTD 추가
- [XmlApp03](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/tree/main/XmlStudy/XmlApp03)
  - XML 데이터 불러오기
  - [XMLHttpRequest](https://developer.mozilla.org/ko/docs/Web/API/XMLHttpRequest) - AJAX(Asynchronous Javascript And Xml)
    - ajax는 XMLHttpRequest 객체가 핵심
    - [순수 자바스크립트 ajax 간단 정리 ( feat. XMLHttpRequest )](https://taylog.tistory.com/194)
    - [Ajax VS XMLHttpRequest VS fetch](https://velog.io/@minw0_o/Ajax-VS-XMLHttpRequest-VS-fetch)
 - [XmlApp04](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/tree/main/XmlStudy/XmlApp04)
    - ⭐⭐[XmlApp04 블로그](https://continua-conatus.tistory.com/531)
    - XML DOM활용 → 로컬(local) XML 읽어내기
    - 콘솔 기반 자바 프로그램
...
- ⭐⭐ [App06 프로그램 소스](https://continua-conatus.tistory.com/526)
- ⭐⭐ [FileSystemApp 06 ~ 08](https://lstory.tistory.com/275)
