...
- <code style="background-color :rgba(8, 152, 236, 0.6)">**객체 직렬화(Object Serialization) - ObjectInputStream, ObjectOutputStream**</code> - 교재(p.)

- ⭐⭐⭐ [**Test183java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test183.java)


### ■■■ 세미프로젝트 진행간 공지사항 ■■■
- 진행 기간 : 06.18(수) 11:00 ~ 06.20(금) 18:00
- 주제 : 자판기(Vending Machine)
	- 어떤 품목을 다루는 자판기인지, 어떤 기능을 탑재한 자판기인지의 여부는 팀 별 회의를 통해 도출하여 진행 (주제 회의, 기획 회의, ...)
	- 클래스의 개념 ~ 자바 기초 과목을 통틀어 공부한 내용을 최대한 모두 적용시킬 수 있도록 구성
