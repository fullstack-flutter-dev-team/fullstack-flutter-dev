...
### ■■■ 자바의 주요(중요) 클래스 ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**String 클래스**</code> - 교재(p.305)
- ⭐ [**Test141.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test141.java)
  - [compareTo](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html#compareTo-java.lang.String-)
  - [format](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html#format-java.lang.String-java.lang.Object...-)
  ...
  - [endsWith(String suffix)](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html#endsWith-java.lang.String-)
  - [equals(Object anObject)](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html#equals-java.lang.Object-)
  - [equalsIgnoreCase(String anotherString)](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html#equalsIgnoreCase-java.lang.String-)
  - [indexOf(String str)](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html#indexOf-java.lang.String-)
  - [lastIndexOf(String str)](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html#lastIndexOf-java.lang.String-)
...
### ■■■ 자바의 주요(중요) 클래스 ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**String 클래스**</code> - 교재(p.310)
- ⭐ [**Test142.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test142.java)
  ```
    사용자로부터 사칙연사수식을 입력받아
...
### ■■■ 자바의 주요(중요) 클래스 ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**StringBuffer 클래스**</code> - 교재(p.314)
...
- ⭐ [**Test143.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test143.java)
  - [append(String str)](https://docs.oracle.com/javase/8/docs/api/java/lang/StringBuffer.html#append-java.lang.String-)
  - [insert(int offset, String str)](https://docs.oracle.com/javase/8/docs/api/java/lang/StringBuffer.html#insert-int-java.lang.String-)
  - [capacity()](https://docs.oracle.com/javase/8/docs/api/java/lang/StringBuffer.html#capacity--)
  - [trimToSize()](https://docs.oracle.com/javase/8/docs/api/java/lang/StringBuffer.html#trimToSize--)
  - []()
  - []()
  - []()
...
- <code style="background-color :rgba(8, 152, 236, 0.6)">**StringBuffer 클래스**</code> - 교재(p.314)
- [**StringBuffer** Class](https://docs.oracle.com/javase/8/docs/api/java/lang/StringBuffer.html)
- ⭐ [**Test144.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test144.java)
  - [delete(int start, int end)](https://docs.oracle.com/javase/8/docs/api/java/lang/StringBuffer.html#delete-int-int-)
  - [insert(int offset, String str)](https://docs.oracle.com/javase/8/docs/api/java/lang/StringBuffer.html#insert-int-java.lang.String-)
  - [replace(int start, int end, String str)](https://docs.oracle.com/javase/8/docs/api/java/lang/StringBuffer.html#replace-int-int-java.lang.String-)
  - [substring(int start, int end)](https://docs.oracle.com/javase/8/docs/api/java/lang/StringBuffer.html#substring-int-int-)


### ■■■ 자바의 주요(중요) 클래스 ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**StringTokenizer 클래스**</code> - 교재(p.328)
- [**StringTokenizer** Class](https://docs.oracle.com/javase/8/docs/api/java/util/StringTokenizer.html)
- ⭐ [**Test145.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test145.java)
  - [countTokens()](https://docs.oracle.com/javase/8/docs/api/java/util/StringTokenizer.html#countTokens--)
  - [hasMoreTokens()](https://docs.oracle.com/javase/8/docs/api/java/util/StringTokenizer.html#hasMoreTokens--)
  - [nextToken()](https://docs.oracle.com/javase/8/docs/api/java/util/StringTokenizer.html#nextToken--)
  - [nextToken(String delim)](https://docs.oracle.com/javase/8/docs/api/java/util/StringTokenizer.html#nextToken-java.lang.String-)
  - []()
  - []()

### ■■■ 자바의 주요(중요) 클래스 ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**문자열 관련 클래스**</code> - 교재(p.)
- <code style="background-color :rgba(8, 152, 236, 0.6)">**캐릭터 셋(Character Set)**</code> - 교재(p.)
- ⭐⭐[**자바의 주요(중요) 클래스 - CharacterSet**](https://chicken-mola.tistory.com/37)
- [Class **StringTokenizer**](https://docs.oracle.com/javase/8/docs/api/java/util/StringTokenizer.html) 
- ⭐ [**Test146.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test146.java)
  - [Class **System**](https://docs.oracle.com/javase/8/docs/api/java/lang/System.html)
    - [getProperty(String key)](https://docs.oracle.com/javase/8/docs/api/java/lang/System.html#getProperty-java.lang.String-)
    - [getProperties()](https://docs.oracle.com/javase/8/docs/api/java/lang/System.html#getProperties--)
  - [Class **String**](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html) 
    - [String(byte[] bytes, Charset charset)](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html#String-byte:A-java.nio.charset.Charset-)
    - [getBytes()](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html#getBytes--)
    - []()


### ■■■ 자바의 주요(중요) 클래스 ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**Calendar 클래스**</code> - 교재(p.332)
- ⭐ [**Test147.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test147.java)
  - [Class **Calendar**](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html)
    - [getInstance()](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html#getInstance--) 
    - [get(int field)](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html#get-int-) 
    - [set(int year, int month, int date)](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html#set-int-int-int-) 
    - [Calendar.YEAR](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html#YEAR) 
    - [Calendar.MONTH](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html#MONTH) 
    - [Calendar.DATE](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html#DATE) 
    - [Calendar.DAY_OF_WEEK](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html#DAY_OF_WEEK) 
    - []() 
