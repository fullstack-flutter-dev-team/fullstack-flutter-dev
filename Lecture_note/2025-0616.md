...
- <code style="background-color :rgba(8, 152, 236, 0.6)">**컬렉션 프레임워크(Collection Framework) - 큐(Queue)**</code> - 교재(p.)
...
- **[Class LinkedList<E>](https://docs.oracle.com/javase/8/docs/api/java/util/LinkedList.html)**
  ...
  ```
- ⭐⭐⭐ [**Test162.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test162.java)
    ...
    ㄴ java.util.AbstractCollection<E>
        ㄴ java.util.AbstractList<E>
              ㄴjava.util.AbstractSequentialList<E>
                  ㄴjava.util.LinkedList<E>
  ```
- ⭐⭐⭐ [**Test163.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test163.java)

### ■■■ 컬렉션 프레임워크(Collection Framework) ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**컬렉션 프레임워크(Collection Framework) - 벡터(Vector)**</code> - 교재(p.)
- **[Interface Queue<E>](https://docs.oracle.com/javase/8/docs/api/java/util/Queue.html)**
- **[Class LinkedList<E>](https://docs.oracle.com/javase/8/docs/api/java/util/LinkedList.html)**
  ```
  java.lang.Object
  ...
  ```
- ⭐⭐⭐ [**Test164.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test164.java)


### ■■■ 컬렉션 프레임워크(Collection Framework) ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**컬렉션 프레임워크(Collection Framework) - 벡터(Vector), Interface Iterator<E>**</code> - 교재(p.)
- **[Interface Queue<E>](https://docs.oracle.com/javase/8/docs/api/java/util/Queue.html)**
- **[Class LinkedList<E>](https://docs.oracle.com/javase/8/docs/api/java/util/LinkedList.html)**
  ```
  java.lang.Object
  ...
  java.util
    ㄴInterface Iterator<E>
  ```
- ⭐⭐⭐ [**Test165.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test165.java)
...
- **[Class Collections](https://docs.oracle.com/javase/8/docs/api/java/util/Collections.html)**
  ...
  ```
- ⭐⭐⭐ [**Test166.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test165.java)


### ■■■ 컬렉션 프레임워크(Collection Framework) ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**컬렉션 프레임워크(Collection Framework) - 벡터(Vector) - 검색 및 삭제**</code> - 교재(p.)
- **[Class Vector<E>](https://docs.oracle.com/javase/8/docs/api/java/util/Vector.html)**
- **[Class Collections](https://docs.oracle.com/javase/8/docs/api/java/util/Collections.html)**
  ```
  java.lang.Object
    ㄴjava.util.AbstractCollection<E>
      ㄴjava.util.AbstractList<E>
          ㄴjava.util.Vector<E>
  ```
- ⭐⭐⭐ [**Test167.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test167.java)
  - [add(E e)](https://docs.oracle.com/javase/8/docs/api/java/util/Vector.html#add-E-)
  - [add(int index, E element)](https://docs.oracle.com/javase/8/docs/api/java/util/Vector.html#add-int-E-)
  - [indexOf(Object o)](https://docs.oracle.com/javase/8/docs/api/java/util/Vector.html#indexOf-java.lang.Object-)
  - [indexOf(Object o, int index)](https://docs.oracle.com/javase/8/docs/api/java/util/Vector.html#indexOf-java.lang.Object-int-)
  - [contains(Object o)](https://docs.oracle.com/javase/8/docs/api/java/util/Vector.html#contains-java.lang.Object-)
  - [remove(int index)](https://docs.oracle.com/javase/8/docs/api/java/util/Vector.html#remove-int-)
  - [remove(Object o)](https://docs.oracle.com/javase/8/docs/api/java/util/Vector.html#remove-java.lang.Object-)
  - []()
  - []()
  - []()
  ...
  java.lang.Object
    ㄴjava.util.AbstractCollection<E>
      ㄴjava.util.AbstractList<E>
          ㄴjava.util.Vector<E>
  ```
- ⭐⭐⭐ [**Test168.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test168.java)

### ■■■ 컬렉션 프레임워크(Collection Framework) ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**컬렉션 프레임워크(Collection Framework) - 벡터(Vector) - 검색, 변경 및 삭제(실습)**</code> - 교재(p.)
- **[Class Vector<E>](https://docs.oracle.com/javase/8/docs/api/java/util/Vector.html)**
- **[Class System](https://docs.oracle.com/javase/8/docs/api/java/lang/System.html)**
- **[Class String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html#compareTo-java.lang.String-)**
  ```
  java.lang.Object
    ㄴjava.lang.System
  ...
  java.lang.Object
    ㄴjava.util.AbstractCollection<E>
      ㄴjava.util.AbstractList<E>
          ㄴjava.util.Vector<E>
  ```
- ⭐⭐⭐ [**Test169.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test169.java)
- **[Class Vector<E>](https://docs.oracle.com/javase/8/docs/api/java/util/Vector.html)**
  - [add(E e)](https://docs.oracle.com/javase/8/docs/api/java/util/Vector.html#add-E-)
  - [indexOf(Object o)](https://docs.oracle.com/javase/8/docs/api/java/util/Vector.html#indexOf-java.lang.Object-)
  - [removeElement(Object obj)](https://docs.oracle.com/javase/8/docs/api/java/util/Vector.html#removeElement-java.lang.Object-)
  - [removeElementAt(int index)](https://docs.oracle.com/javase/8/docs/api/java/util/Vector.html#removeElementAt-int-)
  - [set(int index, E element)](https://docs.oracle.com/javase/8/docs/api/java/util/Vector.html#set-int-E-)
- **[Class System](https://docs.oracle.com/javase/8/docs/api/java/lang/System.html)**
  - [exit(int status)](https://docs.oracle.com/javase/8/docs/api/java/lang/System.html#exit-int-)
- **[Class String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html#compareTo-java.lang.String-)**
...
### ■■■ 컬렉션 프레임워크(Collection Framework) ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**컬렉션 프레임워크(Collection Framework) - Enumeration 과 Iterator 인터페이스**</code> - 교재(p.)
- **[Interface Enumeration<E>](https://docs.oracle.com/javase/8/docs/api/java/util/Enumeration.html)**
- **[Interface Iterator<E>](https://docs.oracle.com/javase/8/docs/api/java/util/Iterator.html)**
  ...
  java.util
      ㄴInterface Iterator<E>
  ```
- ⭐⭐⭐ [**Test170.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test170.java)
- **[Interface Enumeration<E>](https://docs.oracle.com/javase/8/docs/api/java/util/Enumeration.html)**
  - [hasMoreElements()](https://docs.oracle.com/javase/8/docs/api/java/util/Enumeration.html#hasMoreElements--)
  - [nextElement()](https://docs.oracle.com/javase/8/docs/api/java/util/Enumeration.html#nextElement--)
- **[Interface Iterator<E>](https://docs.oracle.com/javase/8/docs/api/java/util/Iterator.html)**
  - [hasNext()](https://docs.oracle.com/javase/8/docs/api/java/util/Iterator.html#hasNext--)
  - [next()](https://docs.oracle.com/javase/8/docs/api/java/util/Iterator.html#next--)
  - [remove()](https://docs.oracle.com/javase/8/docs/api/java/util/Iterator.html#remove--)
