...
### ■■■ 자바의 주요(중요) 클래스 ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**Calendar 클래스 실습**</code> - 교재(p.)
- ⭐ [**Test148.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test148.java)
  - [Class **Calendar**](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html)
    ...
    - ---
    - [Calendar.DAY_OF_MONTH](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html#DAY_OF_MONTH)
    - **[getActualMaximum(int field)](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html#getActualMaximum-int-)**
    - []()
    - []()
  - [Class **GregorianCalendar**](https://docs.oracle.com/javase/8/docs/api/java/util/GregorianCalendar.html)
    - [GregorianCalendar(int year, int month, int dayOfMonth)](https://docs.oracle.com/javase/8/docs/api/java/util/GregorianCalendar.html#GregorianCalendar-int-int-int-) 
    - **[getActualMaximum(int field)](https://docs.oracle.com/javase/8/docs/api/java/util/GregorianCalendar.html#getActualMaximum-int-)**
    - []() 
  ```
    사용자로부터 연, 월을 입력받아
...
### ■■■ 자바의 주요(중요) 클래스 ■■■
- <code style="background-color :rgba(8, 152, 236, 0.6)">**Calendar 클래스 실습**</code> - 교재(p.)
- ⭐ [**Test149.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test149.java)
  - [Class **Calendar**](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html)
    - [getInstance()](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html#getInstance--) 
    - [get(int field)](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html#get-int-) 
    - [set(int year, int month, int date)](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html#set-int-int-int-) 
    ...
    - ---
    - [Calendar.DAY_OF_MONTH](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html#DAY_OF_MONTH)
    - **[add(int field, int amount)](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html#add-int-int-)**
    - **[getActualMaximum(int field)](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html#getActualMaximum-int-)**
    - []()
    - []()
  - [Class **GregorianCalendar**](https://docs.oracle.com/javase/8/docs/api/java/util/GregorianCalendar.html)
    - [GregorianCalendar(int year, int month, int dayOfMonth)](https://docs.oracle.com/javase/8/docs/api/java/util/GregorianCalendar.html#GregorianCalendar-int-int-int-) 
    - **[add(int field, int amount)](https://docs.oracle.com/javase/8/docs/api/java/util/GregorianCalendar.html#add-int-int-)**
    - **[getActualMaximum(int field)](https://docs.oracle.com/javase/8/docs/api/java/util/GregorianCalendar.html#getActualMaximum-int-)**
    - []() 
  ```
...
java.lang.Object
 ㄴjava.lang.Math
```
- <code style="background-color :rgba(8, 152, 236, 0.6)">**Math 클래스**</code> - 교재(p.)
- ⭐⭐⭐ [**Test150.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test150.java)
- **[Class Math](https://docs.oracle.com/javase/8/docs/api/java/lang/Math.html)**
  - [Math.PI](https://docs.oracle.com/javase/8/docs/api/java/lang/Math.html#PI)
  - [Math.E](https://docs.oracle.com/javase/8/docs/api/java/lang/Math.html#E)
  - [Math.sqrt(double a)](https://docs.oracle.com/javase/8/docs/api/java/lang/Math.html#sqrt-double-)
  - [Math.toDegrees(double angrad)](https://docs.oracle.com/javase/8/docs/api/java/lang/Math.html#toDegrees-double-)
  - [Math.toRadians(double angdeg)](https://docs.oracle.com/javase/8/docs/api/java/lang/Math.html#toRadians-double-)
  - [Math.sin(double a)](https://docs.oracle.com/javase/8/docs/api/java/lang/Math.html#sin-double-)
  - [Math.cos(double a)](https://docs.oracle.com/javase/8/docs/api/java/lang/Math.html#cos-double-)
  - [Math.tan(double a)](https://docs.oracle.com/javase/8/docs/api/java/lang/Math.html#tan-double-)
  - [Math.log(double a)](https://docs.oracle.com/javase/8/docs/api/java/lang/Math.html#log-double-)
  - [Math.pow(double a, double b)](https://docs.oracle.com/javase/8/docs/api/java/lang/Math.html#pow-double-double-)
...
java.lang.Object
 ㄴjava.util.Arrays
```
- <code style="background-color :rgba(8, 152, 236, 0.6)">**Random 클래스 실습**</code> - 교재(p.)
- ⭐⭐⭐ [**Test151.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test151.java)
  ```
    로또 번호 생성(난수 발생) 프로그램
...
- **[Class Arrays](https://docs.oracle.com/javase/8/docs/api/java/util/Arrays.html)**
  - **[sort(int[] a)](https://docs.oracle.com/javase/8/docs/api/java/util/Arrays.html#sort-int:A-)**
...
```
- <code style="background-color :rgba(8, 152, 236, 0.6)">**Random 클래스 실습**</code> - 교재(p.)
- ⭐⭐⭐ [**Test152.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test152.java)
  ```
    스무 고개 → 열 고개
