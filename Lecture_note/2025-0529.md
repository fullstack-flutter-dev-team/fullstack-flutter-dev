...
### ■■■ 배열 ■■■
-  배열과 난수 처리(※ Random 클래스 활용) ★
- ⭐⭐[**Test099.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test099.java)
  ```
    사용자로부터 임의의 정수를 입력받아
...
- 값타입 변수 - primet type(원시 데이터 타입)
- ⭐⭐[**Test100.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test100.java)
- ⭐⭐[**Test101.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test101.java)

## **<span style="background-color:#ff55b5"> 자바와 익숙해지기 - **9장. 접근제어 지시자와 정보은닉, 그리고 캡슐화**</span>**
- **정보은닉** 
  - 예) 커피 자판기
  - **[접근 제어 지시자[접근 제한자, 접근 지정자, 접근 제어자]](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/접근제어_지시자.md)**
  - ⭐ 인스턴스 변수를 **private**로 선언하게 되면, 메서가 유일한 접근 수단이 된다.
- **캡슐화**
  - 1차 - 정보은닉 개념
...
- **protected**
  - 상속받은 클래스에서 접근 가능
  - 
- **클래스의 자동 생성자의 접근제어 시시자는 클래스의 접근제어 지시자 유형을 따른다.**

### ■■■ 클래스와 인스턴스 ■■■
-  정보 은닉과 접근제어 지시자
    (접근 지시자, 접근 제어자, 접근 지정자, 접근 제한자
      → 접근 제어와 관련한 예약어)
- ⭐⭐[**Test102.java**](https://github.com/fullstack-flutter-dev-team/fullstack-flutter-dev/blob/main/JavaStudy/Test102.java)
  ```
