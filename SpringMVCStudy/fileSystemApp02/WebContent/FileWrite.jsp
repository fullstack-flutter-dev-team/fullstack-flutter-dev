...
<%
   // FileWrite.jsp
    ...
    // 경로 확인
    System.out.println( COLOR_GREEN + "appRoot : " + appRoot + "<br>" );
    
    // 1. 파일을 쓰기 위해 File 객체를 생성
    File newFile = new File(appRoot, "data/test.txt");
    //-- 확인한 웹 어플리케이션 루트를 기준으로 data 및 test.txt 파일을 구성
    
    // 2. 파일을 생성할 경로까지의 디렉터리가 존재하지 않을 경우
    ...
    // 3-2. FileWriter 객체를 좀 더 편하게 사용하기 위해 PrintWriter 로 감싸줌 → 여과장치
