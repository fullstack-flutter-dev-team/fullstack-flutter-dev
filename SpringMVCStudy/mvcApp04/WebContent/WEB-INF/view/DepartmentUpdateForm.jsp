...
<script type="text/javascript">
    ...
    $(function() {
        ...
        // [부서] 변경 버튼이 클릭되었을 때 수행해야 할 코드 처리
...
<div>
    ...
    <div id="content">
        ...
        <form action="departUpdate.action" method="post" id="departmentForm">
            <table>
                <!-- → [부서] 번호 -->
                <tr>
                    <th>부서번호</th>
                    <td>
                        <input type="text" id="departmentId" name="departmentId" placeholder="부서번호" readonly="readonly" value="${department.departmentId }">
                    </td>
                </tr>
                <tr>
                    <th>부서명</th>
