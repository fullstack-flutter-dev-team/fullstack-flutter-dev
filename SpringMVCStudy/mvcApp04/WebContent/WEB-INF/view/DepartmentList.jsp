...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $(".updateBtn").click(function() {
            ...
            // 수정 폼 페이지 요청
            //-- 요청하며 regionId 넘겨주기
            $(location).attr("href", "departUpdateForm.action?departmentId=" + $(this).val());
            //-- location.href="...";
        });
        ...
        $(".deleteBtn").click(function() {
            ...
            if (confirm("현재 선택한 데이터를 정말 삭제하시겠습니까?"))
            {
                // 테스트
                //alert("삭제 처리");
                $(location).attr("href", "departDelete.action?departmentId=" + $(this).val());
            }
            ...
            <tr>
             ...
             <c:forEach var="department" items="${departmentList }">
                <tr>
                    ...
                    <td>${(department.delCheck > 0) ? "X" : "O" }</td>
                    <td>
