...
public class Employee
{
    ...
    {
        return "Employee [employeeId=" + employeeId + ", name=" + name + ", ssn=" + ssn + ", birthday=" + birthday
                + ", lunarName=" + lunarName + ", telephone=" + telephone + ", departmentId=" + departmentId
                + ", departmentName=" + departmentName + ", positionId=" + positionId + ", positionName=" + positionName
                + ", regionId=" + regionId + ", regionName=" + regionName + ", lunar=" + lunar + ", basicPay="
                + basicPay + ", extraPay=" + extraPay + ", pay=" + pay + ", ssn1=" + ssn1 + ", ssn2=" + ssn2
                + ", grade=" + grade + "]";
    }
