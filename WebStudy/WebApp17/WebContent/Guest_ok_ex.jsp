...
<jsp:useBean id="bbs" class="com.test.GuestDTO"></jsp:useBean>
...
<div>
    <table class="table">
        <tr>
            <th>작성자</th>
            <td><jsp:getProperty property="userName" name="bbs"/></td>
        </tr>
        <tr>
            <th>제목</th>
        ...
        <tr>
            <th>내용</th>
            <td>
                <textarea name="content" class="txt" cols="35" rows="20" readonly="readonly"><jsp:getProperty property="content" name="bbs"/></textarea>
            </td>
        </tr>
    </table>
</div>
