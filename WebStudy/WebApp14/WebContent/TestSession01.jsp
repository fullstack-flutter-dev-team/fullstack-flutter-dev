...
※ session 외에 input태그 type의 hidden 속성을 이용한 정보 전달 가능
 ...
 <div>
     <form action="TestSession02.jsp" method="post" name="inputForm">
         <table class="table">
             <tr>
                 <th>이름</th>
                 <td>
                 ...
                 <td>
                    <span id="msgName" class="errMsg">이름을 입력해야 합니다.</span>
                 </td>
             </tr>
             <tr>
                 <th>전화번호</th>
               ...
               <td>
                   <span id="msgTel" class="errMsg">전화번호를 입력해야 합니다.</span>
                </td>
             </tr>
             <tr style="heigth: 40px;"></tr>
             <tr>
                 <td colspan="2" style="width: 120px; text-align: center;">
                    <a href="javascript:checkInput()"><button type="button" class="btn"  style="width: 250px;">다음페이지로 이동</button>
                    </a>
                 </td>
                 <td></td>
             </tr>
