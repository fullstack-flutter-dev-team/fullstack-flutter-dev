...
<%
// TestSessioin01Ok.jsp 페이지에서
// 이 페이지를 다시 요청할 수 있도록 안내하면서
// session 의 userId 에 『superman』
//          , userName 에 『홍길동』을 담아서 보낸 상황

String userId = (String)session.getAttribute("userId");     //-- down casting
String userName = (String)session.getAttribute("userName"); //-- down casting
//-- 『session.getAttribute("userName");』는
//     Object 타입을 반환하므로 원래의 타입(String)으로 변환하는 과정 필요
...
<!--                                 <input type="password" name="userPwd" class="txt" style="width:150px;"> -->
                        ...
                        <tr style="text-align: center; display: auto;">
                            <td colspan="2">
                                <button type="button" class="btn" style="width:220px;" onclick="sendIt();">로그인</button>
                            </td>
                        </tr>
                    </table>
                </form>
