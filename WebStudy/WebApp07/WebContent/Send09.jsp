...
sbDan.append("    <ul>");
// sbDan.append("        <li><a href='Receive09.jsp?gugudan=1'>1단</a></li>");
// sbDan.append("        <li><a href='Receive09.jsp?gugudan=2'>2단</a></li>");
// sbDan.append("        <li><a href='Receive09.jsp?gugudan=3'>3단</a></li>");
// sbDan.append("        <li><a href='Receive09.jsp?gugudan=4'>4단</a></li>");
// sbDan.append("        <li><a href='Receive09.jsp?gugudan=5'>5단</a></li>");
// sbDan.append("        <li><a href='Receive09.jsp?gugudan=6'>6단</a></li>");
// sbDan.append("        <li><a href='Receive09.jsp?gugudan=7'>7단</a></li>");
// sbDan.append("        <li><a href='Receive09.jsp?gugudan=8'>8단</a></li>");
// sbDan.append("        <li><a href='Receive09.jsp?gugudan=9'>9단</a></li>");
for (int i=1; i<=9; i++) { // i : 1 ~ 9
    // sbDan.append(String.format("<li><a href='Receive09.jsp?dan=%2$d'>%1$d단</a></li>", i, i));
    sbDan.append(String.format("<li><a href='Receive09.jsp?gugudan=%1$d'>%1$d단</a></li>", i));
}
