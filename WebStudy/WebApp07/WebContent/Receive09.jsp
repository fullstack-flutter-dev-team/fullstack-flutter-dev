...
String strDan = request.getParameter("gugudan");
...
try {
    gugudan = Integer.parseInt(strDan);
} catch (Exception e) {
...
// sbGugudan.append("transition-duration: 1s");
sbGugudan.append("'>");
for (int i=1; i<=9; i++) {
    sbGugudan.append(String.format("%d * %d = %d<br>", gugudan, i, (gugudan*i)));
}
