...
<div>
    <h2>가입 확인</h2>
     ...
     <span style="color: skyblue; font-weight: bold;"><%=userName %></span>님, 회원 가입이 완료되었습니다.<br>
      회원님께서 등록하신 전화번호는 <span style="color: skyblue; font-weight: bold;"><%=userTel %></span> 입니다.
</div>
