...
- `_Workspace-Fullstack.code-workspace` : [N/A]
...
- `book_summary/` : [2025-06-16 ~ 2025-06-16]
...
- `KakaoMapStudy/` : [2025-11-10 ~ 2025-11-10]
...
- `Tensorflow_Java/` : [N/A]
  - KR: Java 환경에서의 TensorFlow 관련 실습 자료 가능성.
  - EN: TensorFlow for Java experiments and related material.

- `WebStudy/` : [N/A]
  - KR: 웹 개발 관련 학습 자료입니다.
  - EN: Web development study materials.
...
---
Generated: bilingual overview with commit date ranges for top-level folders.
# fullstack-flutter-dev_github
