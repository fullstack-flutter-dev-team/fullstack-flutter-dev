...
------
SELECT name, SSN, FUNC_IS_JUMIN_VALID(SSN)
...
------------------------
SELECT STUDENT_ID, name, SSN, FUNC_IS_JUMIN_VALID(SSN)
...
-----
SELECT LECTURER_ID, name, SSN, FUNC_IS_JUMIN_VALID(SSN)
...
exec PROC_STUDENT_REG_LOGIN_ID_PW(20000090, 'Quantum7656', '@#world76', :r_data, :r_msg);
PRINT r_data;
PRINT r_msg;
----------------
