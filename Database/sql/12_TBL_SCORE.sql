...
---- 성적 입력
INSERT INTO MIRACLE.TBL_SCORE (SCORE_ID, SCORE_WT, SCORE_PT, SCORE_ATTEND, RC_ID, OCO_ID) VALUES (MIRACLE.SEQ_SCORE.NEXTVAL, TRUNC(90*0.4), TRUNC(67*0.4), TRUNC(100*0.2), 50000015, 40000002);
INSERT INTO MIRACLE.TBL_SCORE (SCORE_ID, SCORE_WT, SCORE_PT, SCORE_ATTEND, RC_ID, OCO_ID) VALUES (MIRACLE.SEQ_SCORE.NEXTVAL, TRUNC(75*0.4), TRUNC(88*0.4), TRUNC(69*0.2), 50000017, 40000002);
