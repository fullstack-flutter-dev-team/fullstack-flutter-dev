...
-- ▣ 데이터 입력
INSERT INTO TBL_ADMIN (ADMIN_ID, NAME, SSN) 
VALUES (SEQ_ADMIN.NEXTVAL, '윤도묵', '041007-1087112');
-- ==>> 1 행 이(가) 삽입되었습니다.

INSERT INTO TBL_ADMIN (ADMIN_ID, NAME, SSN) 
VALUES (SEQ_ADMIN.NEXTVAL, '명이충', '630226-1264931');
-- ==>> 1 행 이(가) 삽입되었습니다.

INSERT INTO TBL_ADMIN (ADMIN_ID, NAME, SSN) 
VALUES (SEQ_ADMIN.NEXTVAL, '강오한', '940823-1687007');
-- ==>> 1 행 이(가) 삽입되었습니다.

INSERT INTO TBL_ADMIN (ADMIN_ID, NAME, SSN) 
VALUES (SEQ_ADMIN.NEXTVAL, '원로규', '690824-1260312');
-- ==>> 1 행 이(가) 삽입되었습니다.
