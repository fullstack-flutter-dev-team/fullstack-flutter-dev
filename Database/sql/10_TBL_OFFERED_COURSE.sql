...
ALTER TABLE TBL_OFFERED_COURSE
  ADD CONSTRAINT FK_TEXTBOOK_TO_OFFERED_COURSE
    FOREIGN KEY (TB_CODE)
    REFERENCES TBL_TEXTBOOK (TB_CODE);
-- ==>> Table TBL_OFFERED_COURSE이(가) 변경되었습니다.

ALTER TABLE TBL_OFFERED_COURSE
  ADD CONSTRAINT FK_SUBJECT_TO_OFFERED_COURSE
    FOREIGN KEY (SUBJ_CODE)
    REFERENCES TBL_SUBJECT (SUBJ_CODE);
-- ==>> Table TBL_OFFERED_COURSE이(가) 변경되었습니다.

ALTER TABLE TBL_OFFERED_COURSE
  ADD CONSTRAINT FK_OCU_TO_OFFERED_COURSE
    FOREIGN KEY (OCU_ID)
...
ALTER TABLE TBL_OFFERED_COURSE
  ADD CONSTRAINT FK_LECTURER_TO_OFFERED_COURSE
...
-- ▣ 제약조건(외래키) 삭제
-- ALTER TABLE TBL_OFFERED_COURSE
--   DROP CONSTRAINT FK_TEXTBOOK_TO_OFFERED_COURSE;

-- ALTER TABLE TBL_OFFERED_COURSE
--   DROP CONSTRAINT FK_SUBJECT_TO_OFFERED_COURSE;

-- ALTER TABLE TBL_OFFERED_COURSE
--   DROP CONSTRAINT FK_OCU_TO_OFFERED_COURSE;

-- ALTER TABLE TBL_OFFERED_COURSE
--   DROP CONSTRAINT FK_LECTURER_TO_OFFERED_COURSE;