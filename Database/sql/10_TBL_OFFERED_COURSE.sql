...
-- ▣ 컬럼 속성 변경
ALTER TABLE TBL_OFFERED_COURSE MODIFY OCO_WGT_WT NUMBER DEFAULT 35;
ALTER TABLE TBL_OFFERED_COURSE MODIFY OCO_WGT_PT NUMBER DEFAULT 35;
ALTER TABLE TBL_OFFERED_COURSE MODIFY OCO_WGT_ATTEND NUMBER DEFAULT 30;
...
INSERT INTO TBL_OFFERED_COURSE (OCO_ID, OCO_SDATE, OCO_EDATE, OCO_WGT_WT, OCO_WGT_PT, OCO_WGT_ATTEND, OCU_ID, SUBJ_CODE, TB_CODE, LECTURER_ID) 
VALUES (SEQ_OC.NEXTVAL, TO_DATE('2025-08-23', 'YYYY-MM-DD'), TO_DATE('2026-01-09', 'YYYY-MM-DD'), 40, 40, 20, 30000002, 73000660, 74000087, 10000002);
...
-- ▣ 조회
SELECT *
FROM TBL_OFFERED_COURSE OC, TBL_SUBJECT SUBJ, TBL_LECTURER LEC
WHERE OC.OCU_ID =  30000002
  AND OC.LECTURER_ID = LEC.LECTURER_ID;
-- WHERE OCU_EDATE IS NULL;

SELECT *
FROM TBL_OFFERED_COURSE OC, TBL_LECTURER LEC
WHERE OC.OCU_ID =  30000002
  AND OC.LECTURER_ID = LEC.LECTURER_ID
  AND OC.LECTURER_ID = 10000002;

SELECT *
FROM TBL_OFFERED_COURSE OC, TBL_LECTURER LEC, TBL_TEXTBOOK TB
WHERE OC.OCU_ID =  30000002
  AND OC.LECTURER_ID = LEC.LECTURER_ID
  AND OC.LECTURER_ID = 10000002;

SELECT * --, TB.TB_NAME, SUBJ.SUBJ_NAME
